...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv2 = depthwise_separable_conv(planes, planes, kernel_size=3, padding=1, bias=True)
...
class HourglassNet(nn.Module):
    ...
    def __init__(self, block, num_stacks=2, num_blocks=4, num_classes=28):
...
def hg1(pretrained=False, progress=True, num_blocks=1, num_classes=28):
    return _hg('hg1', pretrained, progress, num_stacks=1, num_blocks=num_blocks,
               num_classes=num_classes)


def hg2(pretrained=False, progress=True, num_blocks=1, num_classes=28):
    return _hg('hg2', pretrained, progress, num_stacks=3, num_blocks=num_blocks,
               num_classes=num_classes)


def hg8(pretrained=False, progress=True, num_blocks=1, num_classes=28):
