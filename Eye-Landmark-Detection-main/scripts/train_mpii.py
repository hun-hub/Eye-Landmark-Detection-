...
import sys 
sys.path.append('C:/Users/USER/Downloads/anibali (2)')
...
def main(args):
    ...
    # create data loader
    train_dataset = Dataset(args.train_image_path)
    ...
    val_dataset = Dataset(args.val_image_path)
...
if __name__ == '__main__':
    ...
    # Dataset setting
    parser.add_argument('--val_image_path', default='D:/IREYE4TASK_dataset_public/valid', type=str,
                        help='path to images')
    parser.add_argument('--train_image_path', default='D:/IREYE4TASK_dataset_public/train', type=str,
                        help='path to images')
    ...
    # Miscs
    parser.add_argument('-c', '--checkpoint', default='C:/Users/USER/Downloads/anibali (2)/scripts/checkpoint', type=str, metavar='PATH',
